...
int main() {
    ...
    require(table.bind(1U, a.value(), 0x1000ULL));
    require(table.bind(2U, b.value(), 0x2000ULL));
    ...
    require(!table.bind(1U, b.value(), 0x3000ULL));
    require(!table.bind(3U, a.value(), 0x3000ULL));
