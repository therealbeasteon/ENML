...
inline constexpr std::uint32_t invalid_chrome_lease = 15U;
inline constexpr std::uint32_t stale_chrome_lease = 16U;
inline constexpr std::uint32_t chrome_authority_denied = 17U;
} // namespace errors
