...
private:
    FdtView(os::core::ByteSpan blob, std::size_t total_size,
        ...
        : blob_(blob), total_size_(total_size), structure_offset_(structure_offset),
          structure_size_(structure_size), strings_offset_(strings_offset),
          strings_size_(strings_size), version_(version) {}
