...
| entry | 896 | 896 | Reset vector, freestanding memory primitives, the boot routine, syscall-entry decode/dispatch of the three interrupt calls, GICv3 device-source IRQ routing |
| **total** | **8,212** | **8,212** | |
...
- The whole trusted image is **8,212 lines**, against 15,930 for the entire QNX
