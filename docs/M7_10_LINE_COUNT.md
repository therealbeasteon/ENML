...
- `core` is **0.5x its comparable target** — **2,085 semicolons against 4,529**
  (QNX's microkernel *plus* `Proc`), with **2,444 to spare**.
- Against the microkernel alone it is **2,085 against 605** — printed too,
...
- In this gate's own metric `core` is **4,651 lines**, and the whole trusted
  image is **11,183 lines / 4,975 semicolons**.
