...
| machine | 2,661 | 2,661 | The AArch64 port and the `machine.hpp` contract it satisfies |
...
| entry | 751 | 751 | Reset vector, freestanding memory primitives, the boot routine |
| **total** | **7,505** | **7,505** | |
...
- The whole trusted image is **7,505 lines**, against 15,930 for the entire QNX
