...
- `core` is **0.5x its comparable target** — **2,048 semicolons against 4,529**
  (QNX's microkernel *plus* `Proc`), with **2,481 to spare**.
- Against the microkernel alone it is **2,048 against 605** — printed too,
...
- In this gate's own metric `core` is **4,528 lines**, and the whole trusted
  image is **11,060 lines / 4,938 semicolons**.
