...
| --- | --- | --- | --- |
| core | 1,360 | 1,360 | The privileged portable runtime - address spaces and threads, the rendezvous, interrupt dispatch, capability transfer, deadline scheduling authority, the ABI |
| machine | 1,766 | 1,766 | The AArch64 port and the `machine.hpp` contract it satisfies |
...
- The whole trusted image is **4,758 lines**, against 15,930 for the entire QNX
