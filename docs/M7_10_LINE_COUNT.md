...
| entry | 838 | 838 | Reset vector, freestanding memory primitives, the boot routine |
| **total** | **7,896** | **7,896** | |
...
- The whole trusted image is **7,896 lines**, against 15,930 for the entire QNX
