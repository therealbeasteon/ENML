...
- `core` is **0.4x its comparable target** — **1,938 semicolons against 4,529**
  (QNX's microkernel *plus* `Proc`), with **2,591 to spare**.
- Against the microkernel alone it is **1,938 against 605** — printed too,
...
- In this gate's own metric `core` is **4,284 lines**, and the whole trusted
  image is **10,434 lines / 4,656 semicolons**.
...
has no drivers is spending 1,938 semicolons where a shipped 1992 system spent
