...
| machine | 1,151 | 1,151 | The AArch64 port and the `machine.hpp` contract it satisfies |
...
- The whole trusted image is **3,506 lines**, against 15,930 for the entire QNX
