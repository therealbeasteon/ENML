...
- `core` is **0.5x its comparable target** — **2,153 semicolons against 4,529**
  (QNX's microkernel *plus* `Proc`), with **2,376 to spare**.
- Against the microkernel alone it is **2,153 against 605** — printed too,
...
- In this gate's own metric `core` is **4,852 lines**, and the whole trusted
  image is **11,587 lines / 5,155 semicolons**.
