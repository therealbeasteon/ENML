...
| machine — the AArch64 port, including the physical ledger's reservation table | 3,038 |
| discovery — FDT, inventory, GICv3 topology, timer discovery, boot memory | 1,272 |
| entry — reset vector, freestanding memory, interrupt syscall decode, device IRQ routing, the M7.9 end-to-end proof, the decoded fault reporter | 1,134 |
| **total** | **8,979** |
